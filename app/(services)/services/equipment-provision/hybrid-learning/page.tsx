...
const DEVICES = [
  ...
  },
  {
    ...
    brand:
      "Ausdom AW615 1080p Full HD USB Webcam Network Camera with Microphone for PC",
    detail: "",
  },
  {
    id: "kamera2",
...
export default function HybridLearningPage() {
  ...
  return (
    <div className="bg-white text-gray-800">
      {/* ================= HERO SECTION ================= */}
      <motion.section
        className="max-w-7xl mx-auto relative py-48 flex items-center justify-center text-center px-6 bg-linear-to-br from-primary-blue via-green-900 to-primary-blue text-white mt-20 rounded-lg overflow-hidden"
        variants={stagger}
        initial="hidden"
        animate="show"
      >
        ...
        <div className="max-w-4xl relative z-10">
          ...
          >
            Luminoed menghadirkan sistem hybrid learning terintegrasi dengan
            perangkat profesional untuk menciptakan pengalaman belajar
            interaktif, jernih, stabil, dan berkualitas tinggi.
          </motion.p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div variants={fadeUp}>
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              Setup hybrid learning Luminoed menggabungkan green screen
              profesional, komputer performa tinggi, sistem kamera stabil, serta
              audio berkualitas studio.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Dengan sistem ini, pengajar dapat menampilkan presentasi dinamis,
              menambahkan visual interaktif, serta menghadirkan pengalaman
              belajar yang lebih baik untuk siswa online maupun offline.
            </p>
          </motion.div>
        </div>
      </motion.section>
      ...
      <section className="py-24 px-6 bg-white">
        ...
        >
          <motion.h2
            variants={fadeUp}
            className="text-3xl md:text-4xl font-bold mb-4 text-primary-blue"
          >
          ...
          >
            Kami menyediakan paket-paket hybrid learning yang dirancang khusus
            untuk memenuhi berbagai kebutuhan institusi pendidikan dengan
            tingkat kualitas dan fitur yang berbeda.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          <PackageCard
            ...
            layoutImage="/services/hybrid-learning/p2.png"
            features={[
              ...
              "Monitor",
              "TV",
              "Dashboard Eksternal: Google Meet",
          ...
          <PackageCard
            ...
            layoutImage="/services/hybrid-learning/p1.png"
            features={[
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-start">
          {DEVICES.map((item) => (
            <Card
              ...
              onClose={() =>
                setActiveCard((prev) => (prev === item.id ? null : prev))
              }
            />
          ))}
        </div>
      ...
      <section className="py-24 px-6 bg-gray-50">
        ...
        >
          ...
          <motion.p
            ...
            className="text-gray-600 max-w-3xl mx-auto"
          >
            Banyak institusi mengalami kendala teknis saat menjalankan
            pembelajaran hybrid.
          </motion.p>
        </motion.div>
      ...
      {/* ================= CTA ================= */}
      <motion.section
        className="py-24 text-center bg-linear-to-r from-primary-blue to-indigo-900 text-white px-6"
        initial="hidden"
        whileInView="show"
        viewport={{ once: true, amount: 0.4 }}
        variants={stagger}
      >
        ...
        <motion.p
          variants={fadeUp}
          className="max-w-3xl mx-auto mb-8 opacity-90"
        >
          Dengan sistem hybrid learning profesional dari Luminoed, Anda tidak
          hanya mengajar - Anda menciptakan pengalaman belajar modern yang
          interaktif, profesional, dan terpercaya.
        </motion.p>
        <motion.div variants={fadeUp}>
          <Link
            href="/contact"
      ...
      <div className="flex flex-col gap-5 relative">
        ...
        <motion.div className="flex-1">
          ...
          <p className="mt-4 text-sm font-semibold text-primary-blue">
            {expanded
              ? "Geser keluar untuk menutup"
              : "Arahkan untuk melihat detail"}
          </p>
          ...
          >
            ...
            {detail ? (
              <p className="mt-2 text-gray-600 leading-relaxed">{detail}</p>
            ) : null}
            {id === "pc1" && (
            ...
            {id === "mic1" && (
              <ul className="mt-3 text-gray-600 leading-relaxed list-disc pl-5 space-y-1">
                <li>
                  Memiliki jangkauan penangkapan suara omnidirectional 360
                  derajat.
                </li>
                <li>
                  Dilengkapi teknologi peredam noise otomatis dan echo
                  cancellation.
                </li>
                <li>
                  Mendukung koneksi USB untuk fungsi plug-and-play pada
                  komputer.
                </li>
                <li>
                  Dirancang untuk digunakan dengan platform video konferensi
                  seperti Zoom dan Microsoft Teams.
                </li>
              </ul>
            )}
            {id === "mic2" && (
              <ul className="mt-3 text-gray-600 leading-relaxed list-disc pl-5 space-y-1">
                <li>
                  Mikrofon ini dapat menangkap suara dari segala arah dengan
                  radius hingga 3 meter, sehingga ideal untuk digunakan oleh 3–4
                  orang di satu meja rapat.
                </li>
                <li>
                  Dilengkapi teknologi untuk meredam kebisingan latar belakang
                  agar suara vokal terdengar lebih jernih.
                </li>
                <li>
                  Sangat praktis karena langsung bisa digunakan tanpa perlu
                  menginstal driver tambahan. Biasanya terhubung melalui USB
                  atau jack audio 3.5mm.
                </li>
                <li>
                  Bentuknya yang kecil dan datar (tabletop) dilengkapi dengan
                  alas karet anti-slip agar tetap stabil saat diletakkan di atas
                  meja.
                </li>
              </ul>
            )}
            {id === "kamera1" && (
              <ul className="mt-3 text-gray-600 leading-relaxed list-disc pl-5 space-y-1">
                ...
                <li>
                  Lensa kaca berlapis film 5 lapis untuk kejernihan yang lebih
                  baik.
                </li>
                <li>
                  Mikrofon omnidirectional internal dengan pengurangan
                  kebisingan.
                </li>
                <li>
                  Penyesuaian fokus manual, desain anti-distorsi dengan sudut
                  pandang 90 derajat, dan klip fleksibel untuk pemasangan pada
                  layar atau meja.
                </li>
              </ul>
            )}
            {id === "kamera2" && (
              <ul className="mt-3 text-gray-600 leading-relaxed list-disc pl-5 space-y-1">
                ...
                <li>
                  Built-in microphone, typically plug-and-play via USB 2.0, and
                  often includes autofocus.{" "}
                </li>
                <li>
                  Works with Windows, Mac, and various video calling apps like
                  Zoom, Skype, and YouTube.{" "}
                </li>
              </ul>
            )}
          </div>
...
function PackageCard({
  ...
  return (
    <motion.div
      className={`relative rounded-3xl overflow-hidden border-2 transition-all duration-300 cursor-pointer h-fit ${
        expanded
          ? "border-primary-blue/40 shadow-2xl"
    ...
    >
      ...
      {/* Header */}
      <div className={`bg-linear-to-r ${color} text-white p-8`}>
      ...
      <div className="p-8 bg-white/80 backdrop-blur-sm">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {benefits.map((benefit, idx) => (
            <motion.span
              key={idx}
              className={`inline-block px-3 py-1 text-xs font-semibold rounded-full bg-linear-to-r ${color} text-white`}
        ...
        >
          <div className="mb-6 pt-4 border-t border-gray-300">
            <h4 className="font-bold text-primary-blue mb-4 text-lg">
              Paket Mencakup:
            </h4>
            <ul className="space-y-3">
              {features.map((feature, idx) => (
                ...
                >
                  <span
                    className={`shrink-0 w-5 h-5 rounded-full bg-linear-to-r ${color} flex items-center justify-center text-white text-xs font-bold mt-0.5`}
                  >
                    ✓
                  </span>
                  <span>{feature}</span>
          ...
          <div className="pt-4 border-t border-gray-300">
            <Link
              href="/contact"
              className={`inline-block w-full text-center bg-linear-to-r ${color} text-white py-3 rounded-xl font-bold hover:shadow-lg transition-all duration-300 hover:scale-105`}
            >
              Konsultasi {title}
            </Link>
          </div>
