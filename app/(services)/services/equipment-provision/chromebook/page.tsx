...
const AnimatedPrice = dynamic(
  () => import("@/components/animatedPrice"),
  { ssr: false }
);
...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  ...
  try {
    const res = await postFormChromeBook(formData);
    ...
    if (res.success) {
      ...
      throw new Error(res.error || "Gagal mengirim data");
    }
  } catch (error) {
    toast.error(
    ...
    <main className="overflow-hidden">
      ...
      {/* NARRATIVE SECTION */}
        ...
        >
            ...
            <p className="mt-6 text-gray-600 text-sm sm:text-base">
                Dirancang khusus untuk lingkungan pendidikan modern, khususnya sekolah
                dengan kebutuhan kontrol, keamanan, dan efisiensi tinggi.
            </p>
            </motion.div>
            ...
            >
            <p>
                <strong>Lenovo Chromebook 300e</strong> unggul karena menggunakan sistem
                operasi berbasis awan yang memungkinkan proses pemuatan data sangat cepat
                serta keamanan tingkat tinggi melalui fitur <em>penyekatan akses</em>.
            </p>

            <p>
                Melalui <strong>Chrome Education Upgrade (CEU)</strong>, sekolah dapat
                mengelola ribuan perangkat secara terpusat, mengontrol aktivitas siswa di
                kelas, serta memfasilitasi pelaksanaan ujian yang aman dan terpantau.
            </p>

            <p>
                Secara khusus, <strong>Lenovo 300e Chromebook</strong> disorot sebagai
                perangkat keras yang <strong>tangguh dan fleksibel</strong> dengan desain
                lipat yang mendukung berbagai metode pembelajaran — mulai dari kelas
                interaktif hingga pembelajaran mandiri.
            </p>

            <p>
                Selain aspek teknis, solusi ini juga mendukung{" "}
                <strong>digitalisasi pendidikan</strong> di lingkungan sekolah Islam,
                dengan pengelolaan perangkat yang lebih rapi, aman, dan sesuai dengan
                nilai-nilai pembelajaran yang terarah.
            </p>
            </motion.div>
        </motion.div>
        </section>
          ...
          >
            ...
            <motion.div variants={fadeUp}>
              ...
              <p className="mt-6 text-gray-600 text-sm sm:text-base leading-relaxed">
                ...
                mendukung proses belajar yang lebih fokus, aman, dan terkontrol — mulai
                dari kegiatan kelas, ujian berbasis digital, hingga pengawasan guru
                secara real-time.
              </p>
      ...
      {/* AVAILABILITY INFO */}
        ...
        >
            ...
            Jika peminat melebihi <strong>25 unit</strong>, sekolah melalui
            PT Kibar Cendekia Muda akan membuka pemesanan
            <strong> Batch 2</strong>.
            </p>

            <div className="p-6 rounded-2xl bg-yellow-50 border border-yellow-300">
            <p className="text-sm sm:text-base text-gray-700">
                <strong>Catatan Penting:</strong> Harga dan ketersediaan stok untuk batch
                berikutnya <strong>tidak mengikat</strong>, menyesuaikan dengan kurs
                dollar dan stok pasar saat pemesanan.
            </p>

            <p className="mt-4 text-sm sm:text-base text-gray-700">
                <strong>Saran Kami:</strong> Amankan unit di Batch 1 demi kepastian harga
      ...
      <section id="order" className="py-28 bg-white">
        ...
        >
          ...
          >
            <input name="school" placeholder="Nama Pemesan" required className="input" />
            <input name="pic" placeholder="Nama Lengkap Siswa" required className="input" />
            <input name="phone" placeholder="Kelas Saat Ini" required className="input" />
            <input name="email" type="email" placeholder="Email" className="input" />
            <input name="qty" type ="tel" placeholder="Nomor Handphone yang bisa dihubungi" className="input" />
            <button
              type="submit"
              disabled={loading}
