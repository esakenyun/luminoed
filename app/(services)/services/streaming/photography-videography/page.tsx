    ...
    <main className="bg-white text-gray-800 overflow-hidden">
      <section className="pt-32 pb-20">
        ...
        >
          ...
          <p className="mt-6 text-gray-600 text-lg">
            Dokumentasi visual yang fokus pada emosi, detail, dan kenangan
            berharga di lingkungan pendidikan.
          </p>
        </motion.div>
      </section>

      <section className="py-28 bg-linear-to-b from-white to-primary-blue/5">
        <motion.div
        ...
        >
          <motion.div variants={fadeUp} className="mb-14">
            ...
            <p className="mt-4 max-w-2xl text-gray-600">
              Photobooth profesional dengan pencahayaan optimal, backdrop
              custom, dan hasil foto berkualitas tinggi yang siap cetak maupun
              digital.
            </p>
          </motion.div>
        ...
        >
          <motion.div variants={fadeLeft} className="lg:col-span-5">
            ...
            <p className="text-gray-600 mb-6">
              Setiap kelulusan adalah pencapaian. Kami mengabadikannya dengan
              pendekatan visual yang rapi, elegan, dan bernilai kenangan jangka
              panjang.
            </p>
      ...
      <section className="py-24">
        <motion.div
          ...
          variants={fadeUp}
        >
          <h2 className="text-3xl font-bold">Setiap Momen Punya Cerita</h2>
          <p className="mt-6 text-gray-600">
            Biarkan kami membantu mengabadikannya dengan sentuhan visual
            profesional.
          </p>
