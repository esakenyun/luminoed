    ...
    <>
      <section className="w-full">
          ...
          <div className="tablet-landscape-max:w-2/5 flex flex-col md:flex-row justify-center items-center">
            ...
            >
              ...
              <p className="mt-10 text-lg font-medium text-slate-600">
                ...
                dashboard yang disediakan untuk mengetahui karywan yang hadir ,
                terlambat dan jurnal kerja beserta mutabaah pendidik dan tenaga
                pendidik.
              </p>
              ...
              <p className="text-lg font-medium text-slate-600">
                Tenaga pendidik dan pendidik pun dapat melihat capaian dirinya
                berdasarkan mutbaah, presensi ataupun agenda kerja sebagai bahan
                evalaui untuk perbaikan performa.
              </p>
            </motion.div>
        ...
        <motion.section
          ...
          variants={fadeUp}
        >
          <div className="absolute inset-0 bg-linear-to-br from-primary-blue via-primary-blue/90 to-primary-green opacity-95" />
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            ...
            >
              ...
              >
                Smart Talent membantu sekolah memantau presensi, mutabaah, dan
                kinerja tenaga pendidik secara real-time melalui dashboard
                terintegrasi.
              </motion.p>
