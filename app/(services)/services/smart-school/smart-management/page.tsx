        ...
        <>
            <section className="w-full pt-24">
                ...
                <div className="mx-auto max-w-7xl px-6">
                 ...
                 {/* ================= CTA SMART MANAGEMENT ================= */}
                    <motion.section
                        className="relative py-32 mt-30 bg-slate-50 h-150 bg-gradient-to-b to-white"
                        initial="hidden"
                        whileInView="show"
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <motion.div variants={fadeUp}>
                            ...
                            Tingkatkan efisiensi operasional, transparansi data, dan kualitas
                            pengambilan keputusan sekolah melalui sistem manajemen digital yang
