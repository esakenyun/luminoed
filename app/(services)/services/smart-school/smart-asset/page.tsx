    ...
    <>
      <section className="w-full">
        <div className="max-w-7xl mx-auto pt-10 px-6">
          <div className="w-full tablet-landscape-max:w-2/5 flex flex-col md:flex-row justify-center items-center">
            ...
            >
              ...
              <p className="mt-10 text-lg font-medium text-slate-600">
                ...
                realtime menginventaris aset sekolah yang ada di setiap ruangan
                dan secara system dapat dengan segera mengetahui aset mana yang
                perlu maintenance untuk memberikan pelayanan maksimal kepada
                peserta didik.
              </p>
            </motion.div>
          ...
          <Image
            className="hidden tablet-landscape-max:block rounded-2xl absolute right-0 top-[-1%] object-cover"
            ...
            <div className="flex flex-col md:flex-row justify-center gap-16 pt-20">
              ...
              >
                ...
                <div className="p-8 flex flex-col gap-3">
                  ...
                  <p className="text-slate-500 pt-2">
                    Dashboard terpusat yang menampilkan kondisi dan ketersediaan
                    aset di setiap ruang kelas secara real-time. Sekolah dapat
                    memantau status penggunaan, riwayat pemeliharaan, serta umur
                    pakai aset sehingga pengambilan keputusan menjadi lebih
                    cepat, akurat, dan berbasis data.
                  </p>
                  <hr />
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="p-8 flex flex-col gap-3">
                  ...
                  <p className="text-slate-500 pt-2">
                    Setiap aset dilengkkapi QR Code unik yang memudahkan proses
                    identifikasi, pencatatan, dan pelacakan. Melalui pemindaian
                    sederhana, petugas dapat langsung melihat detail aset,
                    lokasi, kondisi terakhir, serta melakukan pelaporan
                    kerusakan atau permintaan maintenance secara instan.
                  </p>
                  <hr />
                </div>
              </motion.div>
        ...
        <motion.section
          className="relative py-32 mt-32 bg-slate-50 h-150 bg-linear-to-b to-white mb-140 md:mb-64 xl:mb-0"
          initial="hidden"
          whileInView="show"
          viewport={{ once: true }}
          variants={stagger}
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <motion.div variants={fadeUp}>
                ...
                <p className="mt-6 text-lg text-slate-600 max-w-xl">
                  Dengan Smart Asset, sekolah dan yayasan dapat memantau
                  inventaris, kondisi aset, serta jadwal maintenance secara
                  real-time melalui sistem terintegrasi berbasis data.
                </p>
