  ...
  return (
    <main className="w-full overflow-hidden">
      <section className="px-4 sm:px-6">
        <div className="relative bg-linear-to-br from-primary-blue via-[#1b1f5c] to-[#0f123f] text-white py-36 max-w-7xl mx-auto px-6 md:px-20 rounded-xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="mt-6 text-lg text-white/80 max-w-xl">
                Program pelatihan IT berbasis praktik untuk guru, siswa, dan
                profesional—dirancang sesuai kebutuhan industri dan pendidikan
                modern.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-6 text-slate-600 leading-relaxed">
              Training IT LuminoED tidak hanya fokus pada teori, tetapi langsung
              mengajak peserta membangun solusi nyata yang dapat diterapkan di
          ...
          <div className="mt-20 relative border-l-2 border-primary-green pl-10 space-y-16">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-bold text-primary-blue">{item}</h3>
                <p className="mt-2 text-slate-600 max-w-xl">
                  Materi dirancang bertahap agar peserta memahami konsep dan
                  mampu menerapkannya secara nyata.
                </p>
              </motion.div>
            ))}
          </div>
