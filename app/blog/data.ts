export const articles = [
  {
    ...
    readTime: "5 min read",
    content: `
      <p>Technology is changing how we teach and learn. In this article, we explore how structured IT training can empower educators.</p>
      <p>Teachers need to be comfortable with digital tools to effectively guide students in the modern world.</p>
    `,
  },
  {
    id: 2,
    ...
    readTime: "8 min read",
    content: `
      <p>Google Workspace for Education offers a suite of tools that can revolutionize school collaboration.</p>
      <p>From Docs to Classroom, learn how to get the most out of these powerful platforms.</p>
    `,
  },
  {
    id: 3,
    ...
    readTime: "4 min read",
    content: `
      <p>AI is not just a buzzword; it's a tool that can transform education management.</p>
      <p>Discover how AI can automate tasks and provide insights for better decision-making.</p>
    `,
  },
];
