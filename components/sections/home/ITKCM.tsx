    ...
    >
      <div className="itk-about max-w-7xl mx-auto px-5 xl:px-0 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
        <div className="itk-about-text">
          ...
          <h2 className="mb-2 font-extrabold uppercase text-[#0A2463] text-3xl md:text-5xl tracking-tight">
            {t("itkcm.about.title")}
          </h2>
          <div className="h-1.5 w-24 bg-[#2EC4B6] rounded-full mb-5" />
          <p className="text-xl font-semibold text-[#0A2463]/70 mb-5 uppercase tracking-wider">
          ...
          <div className="mt-10 flex gap-10">
            {[
              { label: "Schools Served", target: 6, suffix: "+" },
              { label: "Years Experience", target: 3, suffix: "+" },
              { label: "Services Offered", target: 6, suffix: "" },
            ].map((s) => (
              <div key={s.label}>
                <p className="text-4xl font-extrabold text-[#0A2463] leading-none">
        ...
        <div className="itk-about-img relative">
          ...
          <div className="absolute -bottom-5 -right-5 w-28 h-28 bg-[#2EC4B6] rounded-3xl -z-10" />
          <div className="absolute -top-5  -left-5  w-28 h-28 bg-[#0A2463] rounded-3xl -z-10" />
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-5 xl:px-0 mb-32">
        <div className="itk-why-head text-center mb-14">
          ...
          <div className="h-1.5 w-24 bg-[#2EC4B6] mx-auto rounded-full" />
        </div>
        ...
        <div className="itk-why-grid grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div
              key={card.title}
              className="itk-why-card p-10 rounded-[40px] bg-[#F5F5F3] hover:shadow-xl transition-shadow duration-300"
            >
              <div
              ...
              <h3 className="text-2xl font-bold text-[#0A2463] mb-4 uppercase">
                {card.title}
              </h3>
      ...
      <div className="itk-trans max-w-7xl mx-auto px-5 xl:px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="itk-trans-text order-1 lg:order-2">
            ...
            <h2 className="mb-2 font-extrabold uppercase text-[#0A2463] text-3xl md:text-4xl leading-tight">
              {t("itkcm.transformation.title")}
            </h2>
            <div className="h-1.5 w-24 bg-[#2EC4B6] rounded-full mb-7" />
            ...
            <ul className="itk-checklist space-y-4 mb-10">
              {[
                ...
                >
                  <CheckCircle2 className="text-[#2EC4B6] shrink-0" />
                  {item}
                </li>
              ))}
            </ul>
            ...
            <button
              className="inline-flex items-center gap-2 rounded-2xl bg-[#0A2463] px-8 py-4 text-white font-bold hover:bg-[#0d2f7a] transition-all shadow-lg hover:shadow-xl"
